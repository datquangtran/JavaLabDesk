...
public class Main {
    ...
    public void controller(ArrayList<course> cs) {
        //hien ra man Main
        f1.setVisible(true);
        // add hanh dong vao nut BtnAdd
        f1.getBtnAdd().addActionListener(new ActionListener() {
            @Override
            //khi bam vao nut Add thi hien ra form AddCourses
            public void actionPerformed(ActionEvent ae) {
                f2.setVisible(true);
            }
        });
        // add hanh dong vao nut Search
